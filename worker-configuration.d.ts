/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6412a9c1b0281dc1c961bb4d4ebbf7db)
...
declare namespace Cloudflare {
	interface Env {
		...
		DATABASE_URL: string;
		WORKER_ENV: string;
		GAME_SERVER: DurableObjectNamespace<import("./src/index").GameServer>;
		DB: D1Database;
		freshmen68_queues: Queue;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "PUBLIC_BETTER_AUTH_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "FRONTEND_URL" | "DATABASE_URL" | "WORKER_ENV">> {}
}
